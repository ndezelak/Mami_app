 ...
 * <p/>
 * Description:
 * Adapter for your input_activity_fragment_chooser gridview which has custom frames containing imageviews.
 */
...
public class GridViewAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (v == null) {
            v = mInflater.inflate(R.layout.input_activity_fragment_chooser_grid_item, viewGroup, false);
        }
