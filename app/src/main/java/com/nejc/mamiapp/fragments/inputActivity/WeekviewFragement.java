...
import com.nejc.mamiapp.adapters.inputActivity.WeekDaysAdapter;
...
public class WeekviewFragement extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View listviewLayout = inflater.inflate(R.layout.input_activity_fragment_month, container, false);
